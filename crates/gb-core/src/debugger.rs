    ...
    pub fn render_text(&self) -> String {
        ...
        format!(
            concat!(
                ...
                "apu.console_model={:?} apu.revision={:?} apu.status={:?} apu.powered={} apu.div_apu={}\n",
                ...
                "ppu.bg_startup_source_state={:?} ppu.bg_push_entry_delay_remaining={} ppu.bg_transfer_phase={:?} ppu.bg_current_transfer_x={} ppu.bg_current_transfer_lane={:?} ppu.bg_current_transfer_source_window={:?} ppu.bg_current_transfer_backing={:?} ppu.bg_current_transfer_readiness={:?} ppu.bg_current_transfer_kind={:?}\n",
                "ppu.bg_fifo_pixels={:?}\n",
            ...
            self.sgb_host.packet_transport.phase,
            self.sgb_host.packet_transport.pending_data_bit,
            ...
            self.sgb_host.packet_transport.invalid_stop_bit_count,
