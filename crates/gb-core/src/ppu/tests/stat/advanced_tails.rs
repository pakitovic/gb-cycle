...
fn cpu_stat_read_publishes_hblank_for_terminal_x163_visible_tail_on_saturated_sprite_lines() {
    let ppu = terminal_tail_rig(TerminalTailConfig::default());
...
fn cpu_stat_read_publishes_hblank_for_terminal_x164_placeholder_only_visible_tail_on_saturated_sprite_lines()
 {
    let ppu = terminal_tail_rig(TerminalTailConfig {
        blank_frame_active: true,
        mode0_start_dot: MODE0_START_DOT + 24,
        current_transfer_x: 164,
        visible_pixels_output: 156,
        fifo_len: 4,
        fetcher_stage: PpuBgFetcherStage::TileIndex,
        line_dot: MODE0_START_DOT + 24,
        ..TerminalTailConfig::default()
    });
...
fn cpu_stat_read_publishes_hblank_for_terminal_x159_ready_tail_on_saturated_sprite_lines() {
    let ppu = terminal_tail_rig(TerminalTailConfig {
        mode0_start_dot: MODE0_START_DOT + 64,
