...
pub use sgb::{
    ...
    SGB_BORDER_TILEMAP_VISIBLE_HEIGHT, SGB_BORDER_TILEMAP_WIDTH,
    SGB_BORROWED_BORDER_EXTRACTION_FRAME_LIMIT, SGB_COMMAND_MAX_PACKETS, SGB_COMMAND_PACKET_BYTES,
    SGB_CONTROLLER_COUNT, SGB_DATA_SND_INLINE_BYTES, SGB_FRAME_HEIGHT, SGB_FRAME_PIXELS,
    SGB_FRAME_WIDTH, SGB_LCD_FRAME_ORIGIN_X, SGB_LCD_FRAME_ORIGIN_Y, SGB_LCD_HEIGHT,
    SGB_LCD_PIXELS, SGB_LCD_WIDTH, SGB_OBJ_OAM_PAYLOAD_BYTES, SGB_SCREEN_PALETTE_COLORS,
    SGB_SCREEN_PALETTE_COUNT, SGB_SHELL_BORDER_FADE_FRAMES, SGB_SNES_DATA_TRN_BYTES,
    SGB_SYSTEM_PALETTE_COUNT, SGB_VRAM_TRANSFER_BYTES, SgbApuRamAddress, SgbAttributeFileState,
    SgbAttributeMap, SgbAttributeState, SgbAudioState, SgbBorderMapEntry, SgbBorderPalette,
    SgbBorderState, SgbBorderTileData, SgbBorderTileMap, SgbBorrowedBorder,
    SgbChrTransferSelection, SgbChrTransferTileType, SgbCommandAcceptance, SgbCommandState,
    SgbCompletedVramTransfer, SgbDataSendRequest, SgbDataTransferRequest, SgbFrameCompositionError,
    SgbHost, SgbHostAudioRequest, SgbHostBackend, SgbHostBackendKind, SgbHostBackendRequest,
    SgbHostBackendRequestKind, SgbHostBackendResponse, SgbHostSnapshot, SgbHostStatus,
    SgbJoypLineState, SgbJumpRequest, SgbLcdCompositionError, SgbLcdRgb555Frame,
    SgbMultiplayerState, SgbObjOamPayload, SgbObjTransferState, SgbPacketGateState, SgbPacketTrace,
    SgbPacketTraceStatus, SgbPacketTransportPhase, SgbPacketTransportState, SgbPalSetOptions,
    SgbPaletteState, SgbPendingVramTransfer, SgbPlayerPaletteOverrideState, SgbRealBootAsset,
    SgbRgb555Color, SgbScreenMask, SgbScreenPalette, SgbShellBorderTransitionPhase,
    SgbShellBorderTransitionState, SgbShellState, SgbSnesAddress, SgbSnesHostRequest,
    SgbSnesHostState, SgbSoundEffectControl, SgbSoundRequest, SgbSoundTransferPacket,
    SgbSoundTransferRequest, SgbStartupState, SgbSystemControlState, SgbSystemPaletteState,
    SgbVideoState, SgbVramTransferBuffer, SgbVramTransferError, SgbVramTransferPhase,
    SgbVramTransferState, SgbVramTransferTarget, extract_initial_sgb_borrowed_border,
    sgb_header_accepts_borrowed_border,
};
pub use speed::{
