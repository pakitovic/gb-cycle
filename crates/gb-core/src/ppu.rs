...
pub struct Ppu {
    ...
    dmg_lcdc0_current_line_bg_enable_write_count: u8,
    dmg_lcdc3_current_line_bg_tilemap_write_count: u8,
    dmg_lcdc0_bg_enable_visible_hold_override: Option<bool>,
    dmg_lcdc0_bg_enable_visible_hold_pixels_remaining: u8,
