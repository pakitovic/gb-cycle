use gb_core::{
    ...
    CartridgeSlot, CompatibilityPolicy, ConsoleModel, Huc3RtcPersistentState, Machine,
    MachineConfig, Mbc3RtcPersistentState, PersistentCartState,
};
use gb_persistence::{
    ...
    HardwarePersistenceSaveResult, HardwarePersistenceTrigger, InMemoryCartridgeSaveBackend,
...
fn huc3_persistent_state(ram: Vec<u8>) -> PersistentCartState {
