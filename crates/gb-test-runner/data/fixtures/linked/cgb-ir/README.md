...
These fixtures validate only the core CGB-to-CGB optical topology and `RP` sensor threshold path; Pokémon Pikachu 2, Pocket Sakura, TV remotes, lamps, Chee Chai Alien, HuC1/HuC3-to-CGB IR, and title-specific external protocols remain outside this fixture contract.
