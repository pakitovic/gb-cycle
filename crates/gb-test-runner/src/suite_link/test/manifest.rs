...
#[test]
fn parser_accepts_dmg0_participant_revision() {
    ...
    let suite =
        parse_link_suite_manifest_for_test(Path::new("dmg0.link.suite.toml"), "linked", &manifest)
            .expect("DMG0 participant should parse");
