...
- Before opening or updating a pull request, run at least `make check` locally so formatting, clippy, tests, typos, `cargo deny`, and the repository-gated external Blargg DMG suites do not first surface in CI.
