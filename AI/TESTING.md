...
Include MBC3 tests for RAM / RTC enable behavior, standard RAM-bank selectors `0x00..=0x03`, reserved selector values `0x04..=0x07`, latch `0x00 -> 0x01`, live-versus-latched RTC state, halt/carry/day-counter behavior, disabled-RAM / RTC policy, and powered-off elapsed-time handling through an injected deterministic clock.
