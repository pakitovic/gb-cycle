...
- The runner now advances MBC3 RTC through a deterministic injected `32.768 kHz` clock during ROM-suite execution, including CGB RealBoot handoff, so CGB RTC ROM tests do not depend on host wall-clock timing or shortcut through `DIV` / timer state.
