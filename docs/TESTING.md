...
- The GitHub `test-roms` workflow currently runs the same workflow-managed non-CGB DMG families as the local `make test-roms` aggregator: `acid`, the full Blargg DMG family (`cpu_instrs 01..11`, `halt_bug`, `instr_timing`, `mem_timing 01..03`, `mem_timing-2 01..03`, `oam_bug 1..6,8`, and `dmg_sound 01..12`), `daid`, `hacktix`, `cpp`, the three Mooneye chunks `mooneye-acceptance`, `mooneye-mbc1-mbc5`, and `mooneye-mbc2`, and `mealybug-tearoom-tests`.
