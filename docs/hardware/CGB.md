...
- host-side infrared light injection, non-CGB IR devices other than the modeled `PokemonPikachuColor` accessory, HuC1/HuC3-to-CGB IR, title-specific external IR protocols, and hardware-revision-specific analog sensor tuning beyond the provisional CGB-to-CGB timing constants
