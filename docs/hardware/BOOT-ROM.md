...
| `GameBoyColor` | `CpuCgbC`, `CpuCgbD`, `CpuCgbE` | `CpuCgbE` | `cgbE_boot.bin` | CGB post-boot profile aligned to the validated CGB direct-start handoff fields |
...
- Strict RealBoot validation for explicit `CpuCgbC` or `CpuCgbD` requires canonical `cgb_boot.bin` as a `2304`-byte sparse asset with SHA-256 `b4f2e416a35eef52cba161b159c7c8523a92594facb924b3ede0d722867c50c7`; `cgb0_boot.bin` remains a recognized future-revision asset, the default `CpuCgbE` profile selects `cgbE_boot.bin` with SHA-256 `c56299bedd56debdbf36442238636bf5887a65c5173b33995682052353804da9` automatically, and the AGB `CpuAgbA` profile selects `cgb_agb_boot.bin` with SHA-256 `fe3cceb79930c4cb6c6f62f742c2562fd4c96b827584ef8ea89d49b387bd6860` automatically. `gba_bios.bin` is not part of this GB/C boot-ROM asset contract.
