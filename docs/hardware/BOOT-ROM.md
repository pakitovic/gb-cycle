...
| `GameBoyColor` | `CpuCgb0`, `CpuCgbC`, `CpuCgbD`, `CpuCgbE` | `CpuCgbE` | `cgbE_boot.bin` | CGB0 or standard CGB post-boot profile selected by revision and aligned to validated CGB direct-start handoff fields |
