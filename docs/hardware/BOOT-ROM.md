...
- Strict RealBoot validation for explicit `CpuCgbC` or `CpuCgbD` requires canonical `cgb_boot.bin` as a `2304`-byte sparse asset with SHA-256 `b4f2e416a35eef52cba161b159c7c8523a92594facb924b3ede0d722867c50c7`; `cgb0_boot.bin` remains a recognized future-revision asset, and the default `CpuCgbE` profile selects `cgbE_boot.bin` with SHA-256 `c56299bedd56debdbf36442238636bf5887a65c5173b33995682052353804da9` automatically.
