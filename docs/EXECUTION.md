...
- When rerunning curated external ROM suites for an existing failure or timing-sensitive change, follow the mandatory matching `/.roms/test/test-report.md`, `/.roms/test/test-report-extra.md`, or `/.roms/test/test-report-docboy.md` before/after workflow from `docs/index.md` and `docs/TESTING.md`.
