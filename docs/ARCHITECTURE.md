...
- `ConsoleModel::GameBoyColor` plus `OperatingMode::CgbCompatibility` should represent a CGB-family machine running monochrome software; it is not the same thing as DMG-family silicon.
