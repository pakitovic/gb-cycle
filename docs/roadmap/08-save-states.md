...
- Phase 8.5 keeps the `.gbstate` v1 host integration boundary and does not change `MachineSaveState` DTOs, rewind buffering, compression, or deltas; Phase 8.8 reuses the same host integration boundary after the ROM-less cartridge DTO update.
