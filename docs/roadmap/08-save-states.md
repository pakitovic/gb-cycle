...
- Phase 8.7 still stores full snapshots only. Compression, delta encoding, multi-machine rewind coordination, CLI rewind, and richer frontend settings/overlays remain future work.
