...
- Still out of scope: Pokémon Pikachu 2, Pocket Sakura, TV remotes, lamps, Chee Chai Alien, HuC1/HuC3-to-CGB IR, title-specific external workflows, hardware-revision-specific analog calibration, and any protocol that needs more than the native CGB peer-emitter seam.
